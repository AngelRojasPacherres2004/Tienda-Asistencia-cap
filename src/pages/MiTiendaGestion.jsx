...
const blank = (type) => ({
  documento: { area_responsable:"", codigo:"", tipo_documento:DOCUMENTOS[0], frecuencia_revision:"Anual", fecha_emision:"", fecha_vencimiento:"", estado:"vigente", archivo:null },
